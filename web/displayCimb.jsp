...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="stylesheet/displayCimb.css">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <title>Display CIMB Bank Transaction Page</title>
    <style>
        /* Global Styles */
        body {
        }
...
<body>
    ...
    <div class="container">
        <form method="POST" action="printTicketAfterTransaction.jsp">
            <img src="cimb.jpg" alt="CIMB Bank">
            <div class="head">
                Payment Details
                <hr>
            </div>
