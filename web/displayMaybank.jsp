<!--I've made the following improvements:
    ...
    Added comments to sections and components for better understanding.
    Grouped related styles together.
    Added a container class to wrap the form for better alignment and responsiveness.
    Removed unused styles and unnecessary styling.
    Fixed indentation and formatting issues.
    Updated the <title> tag to reflect MayBank transaction page.
    Added global styles for body, links, and buttons.
    Adjusted the styles to improve consistency and readability.-->
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="stylesheet/displayMaybank.css">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <title>Display MayBank Transaction Page</title>
    <style>
        /* Global Styles */
        body {
        }
...
<body>
    ...
    <div class="container">
        <form method="POST" action="printTicketAfterTransaction.jsp">
            <img src="maybank.jpg" alt="Maybank Bank">
            <div class="head">
                Payment Details
                <hr>
            </div>
